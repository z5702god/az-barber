  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={[styles.header, { paddingHorizontal: r.sp.md, paddingVertical: r.sp.md }]}>
        ...
        <Text style={[styles.headerTitle, { fontSize: r.fs.lg }]}>隱私權政策</Text>
      ...
      >
        ...
        <Text style={[styles.sectionTitle, { fontSize: r.fs.md, marginTop: r.sp.lg, marginBottom: r.sp.sm }]}>2. 資料使用目的</Text>
        <Text style={[styles.bodyText, { fontSize: r.fs.sm, lineHeight: r.scale(22, 28) }]}>
          我們蒐集的資料僅用於以下目的：
          {'\n\n'}• 提供預約服務及管理
          {'\n'}• 發送預約確認、提醒及變更通知
        ...
        <Text style={[styles.sectionTitle, { fontSize: r.fs.md, marginTop: r.sp.lg, marginBottom: r.sp.sm }]}>3. AI 服務說明</Text>
        <Text style={[styles.bodyText, { fontSize: r.fs.sm, lineHeight: r.scale(22, 28) }]}>
          本 App 提供 AI 預約助理功能，使用第三方 AI 服務（OpenAI）處理您的對話訊息。您與 AI 助理的對話內容將傳送至 OpenAI 伺服器進行處理，僅用於生成回覆，不會用於訓練 AI 模型。
        </Text>

        <Text style={[styles.sectionTitle, { fontSize: r.fs.md, marginTop: r.sp.lg, marginBottom: r.sp.sm }]}>4. 資料儲存與安全</Text>
        <Text style={[styles.bodyText, { fontSize: r.fs.sm, lineHeight: r.scale(22, 28) }]}>
        ...
        <Text style={[styles.sectionTitle, { fontSize: r.fs.md, marginTop: r.sp.lg, marginBottom: r.sp.sm }]}>5. 第三方服務</Text>
        <Text style={[styles.bodyText, { fontSize: r.fs.sm, lineHeight: r.scale(22, 28) }]}>
          本 App 使用以下第三方服務：
          {'\n\n'}• Supabase：資料庫及使用者認證
          {'\n'}• OpenAI：AI 對話功能
        ...
        <Text style={[styles.sectionTitle, { fontSize: r.fs.md, marginTop: r.sp.lg, marginBottom: r.sp.sm }]}>6. 您的權利</Text>
        <Text style={[styles.bodyText, { fontSize: r.fs.sm, lineHeight: r.scale(22, 28) }]}>
          您擁有以下權利：
        ...
        <Text style={[styles.sectionTitle, { fontSize: r.fs.md, marginTop: r.sp.lg, marginBottom: r.sp.sm }]}>7. Cookie 與追蹤</Text>
        <Text style={[styles.bodyText, { fontSize: r.fs.sm, lineHeight: r.scale(22, 28) }]}>
          本 App 不使用 Cookie。我們不進行跨 App 追蹤。
        </Text>

        <Text style={[styles.sectionTitle, { fontSize: r.fs.md, marginTop: r.sp.lg, marginBottom: r.sp.sm }]}>8. 兒童隱私</Text>
        <Text style={[styles.bodyText, { fontSize: r.fs.sm, lineHeight: r.scale(22, 28) }]}>
          本 App 不針對 13 歲以下的兒童提供服務。我們不會刻意蒐集兒童的個人資料。
        </Text>

        <Text style={[styles.sectionTitle, { fontSize: r.fs.md, marginTop: r.sp.lg, marginBottom: r.sp.sm }]}>9. 政策變更</Text>
        <Text style={[styles.bodyText, { fontSize: r.fs.sm, lineHeight: r.scale(22, 28) }]}>
